            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-xs-4">
                        <div class="top-number"><p><i class="fa fa-phone-square"></i>  +62 897.689.4447</p></div>
                    </div>
     ...
     <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="about-us.html">Pendaftaran</a></li>
                        <li><a href="services.html">Cara Deposit</a></li>
                        <li><a href="portfolio.html">Cara Transaksi</a></li>
                        <!--
                        <li class="dropdown">
                        ...
                        -->
                        <li><a href="blog.html">Harga</a></li> 
        ...
        <div class="container">
           <div class="center wow fadeInDown">
                <h2>Pulsa Elektrik All Operator</h2>
            ...
            <div class="row">
                <div class="features">
                    ...
                    <div class="media services-wrap wow fadeInDown animated" style="visibility: visible; animation-name: fadeInDown;">
                        <div class="pull-left">
                            <img class="img-responsive" src="<?php echo HTTP_BASE.'assets/images/services/services3.png'?>">
                        </div>
                        <div class="media-body">
                            <h3 class="media-heading">Software Handal</h3>
                            <p>Didukung Software Pulsa yang handal. 
                                Menjadikan transaksi lebih stabil, aman, cepat, & akurat.</p>
                        </div>
                    </div>
                </div>
                    <div class="col-sm-6 col-md-4">
